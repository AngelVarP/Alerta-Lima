...
const page = usePage();
const isEditingSelf = page.props.auth.user.id === props.usuario.id;
    ...
    <AdminLayout>
        ...
        <div class="max-w-4xl">
            ...
            <div class="mb-6">
                ...
                <h3 class="text-2xl font-bold text-gray-900 dark:text-white">Editar Usuario</h3>
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                    Modifique los datos del usuario {{ usuario.nombre }} {{ usuario.apellido }}
                </p>
            </div>

            <!-- Alerta si está editándose a sí mismo -->
            <div v-if="isEditingSelf" class="mb-6 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-xl">
                <div class="flex items-start gap-3">
                    <span class="text-2xl">⚠️</span>
                    <div>
                        <p class="text-sm font-medium text-yellow-800 dark:text-yellow-400">
                            Está editando su propia cuenta
                        </p>
                        <p class="text-xs text-yellow-700 dark:text-yellow-500 mt-1">
                            Tenga cuidado al cambiar sus roles o estado, podría perder acceso al sistema.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <form @submit.prevent="submit">
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                    ...
                    <!-- Estado -->
                    <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                        <h4 class="text-lg font-bold text-gray-900 dark:text-white mb-4">Estado del Usuario</h4>
                        <label class="flex items-center gap-3 cursor-pointer">
                            ...
                            />
                            <div>
                                <span class="text-sm font-medium text-gray-900 dark:text-white">Usuario Activo</span>
                    ...
                    <div class="p-6">
                        <h4 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Cambiar Contraseña</h4>
